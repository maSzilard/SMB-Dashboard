<template>
  <b-card-code no-body title="Translucent">
    <b-card-body>
      <b-card-text>
        ...
        <span>
          ...
          document, rather than transporting it to a
        </span>
        <code>&lt;b-toaster&gt;</code>
    ...
    <div class="translucent-wrap bg-primary rounded-bottom p-1">
      <b-toast id="example-toast3" v-model="visible" static no-auto-hide>
        <template #toast-title>
          <div class="d-flex flex-grow-1 align-items-center mr-1">
            <b-img
              :src="require('@/assets/images/logo/smbg-logo.png')"
              class="mr-1"
              height="18"
              width="25"
              alt="Toast image"
